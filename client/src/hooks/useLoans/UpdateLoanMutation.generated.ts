...
export type UpdateLoan2MutationVariables = {
  id: Types.Scalars["ID"];
  changes: Types.LoanUpdateInput;
};

export type UpdateLoan2Mutation = { readonly __typename?: "Mutation" } & {
...
export const UpdateLoan2Document: DocumentNode = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "UpdateLoan2" },
      variableDefinitions: [
        {
...
export type UpdateLoan2MutationFn = ApolloReactCommon.MutationFunction<
  UpdateLoan2Mutation,
  UpdateLoan2MutationVariables
>;

/**
 * __useUpdateLoan2Mutation__
 *
 * To run a mutation, you first call `useUpdateLoan2Mutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useUpdateLoan2Mutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [updateLoan2Mutation, { data, loading, error }] = useUpdateLoan2Mutation({
 *   variables: {
 *      id: // value for 'id'
 ...
 * });
 */
export function useUpdateLoan2Mutation(
  baseOptions?: ApolloReactHooks.MutationHookOptions<UpdateLoan2Mutation, UpdateLoan2MutationVariables>,
) {
  return ApolloReactHooks.useMutation<UpdateLoan2Mutation, UpdateLoan2MutationVariables>(
    UpdateLoan2Document,
    baseOptions,
  );
}
export type UpdateLoan2MutationHookResult = ReturnType<typeof useUpdateLoan2Mutation>;
export type UpdateLoan2MutationResult = ApolloReactCommon.MutationResult<UpdateLoan2Mutation>;
export type UpdateLoan2MutationOptions = ApolloReactCommon.BaseMutationOptions<
  UpdateLoan2Mutation,
  UpdateLoan2MutationVariables
>;
